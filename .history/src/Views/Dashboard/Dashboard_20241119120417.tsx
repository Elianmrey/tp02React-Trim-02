...
export default function DashBoard() {
    ...
    function Ordenation(stateToOrder: [{userId: number, name: string, birthdate: string, occupation: string, experience: number}],paramOrdenation: boolean = false, orderType: string =) {
