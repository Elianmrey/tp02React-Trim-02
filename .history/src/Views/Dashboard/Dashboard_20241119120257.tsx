...
export default function DashBoard() {
    ...
    function Ordenation(stateToOrder: [{userId: number, name: string, birthdate: string, occupation: string, experience: number}],paramOrdenation: boolean = false) {
        if(paramOrdenation=== 'older')
        setFilters(stateToOrder.sort((a,b) => { return a.experience - b.experience }));
        else if (paramOrdenation === 'newer')
