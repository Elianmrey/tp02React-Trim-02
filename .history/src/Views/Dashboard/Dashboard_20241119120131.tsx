...
export default function DashBoard() {
    ...
    function Ordenation(stateToOrder: [{userId: number, name: string, birthdate: string, occupation: string, experience: number}],paramOrdenation: string) {
        if(paramOrdenation=== 'older')
        setFilters(stateToOrder.sort((a,b) => { return a.experience - b.experience }));
        else if(paramOrdenation === 'newer') setFilters(stateToOrder.sort((a, b) => { return b.experience - a.experience }));
    }
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel onClick={()=>Ordenation(filters,'older')} control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" />
