...
export default function DashBoard() {
    ...
    function orderResult(filter, stateToOrder: [{ userId: number, name: string, birthDate: string, occupation: string, experience: number }], orderParam: boolean,orderType:string ) {
