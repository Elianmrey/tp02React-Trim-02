...
export default function DashBoard() {
    ...
    return (
        <div className={styles.container}>
            ...
            <Container sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', width: '100%', backgroundColor: '#444', borderRadius: '10px', padding: '10px'}}>
...
<Container sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', width: '100%', backgroundColor: '#444', borderRadius: '10px', padding: '10px'}}></Container>
