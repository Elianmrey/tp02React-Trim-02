...
export default function DashBoard() {
    ...
    {
        const filter: [{userId: number, name: string, birthdate: string, occupation: string, experience: number  }] = dataBase.sort((a,b)=>b.experience - b.experience)
        setFilters(filter);
    }
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel onClick={()=>Ordenation(dataBase)} control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" />
