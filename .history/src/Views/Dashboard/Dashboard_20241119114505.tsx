...
export default function DashBoard() {
    ...
    function Ordenation(paramOrdenation: string) {
        if(paramOrdenation=== 'older')
            return setFilters(dataBase.sort((a, b) => { return a.experience - b.experience }));
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" onClick={OlderOrdenation}/>
