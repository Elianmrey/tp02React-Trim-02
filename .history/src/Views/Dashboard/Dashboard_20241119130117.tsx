    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel onClick={()=>setFilters(()=>dataBase.sort((a, b) => new Date(b.birthDate))} control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" />
