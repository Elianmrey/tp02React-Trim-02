...
export default function DashBoard() {
    ...
    function orderResult(stateToOrder: [{ userId: number, name: string, birthDate: string, occupation: string, experience: number }], orderParam: boolean,orderType:string ) {
        
        Ordenation(stateToOrder, orderParam, orderType);
        return (filters:Array<{ userId: number, name: string, birthDate: string, occupation: string, experience: number }>)
    }
