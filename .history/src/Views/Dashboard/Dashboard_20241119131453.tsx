...
export default function DashBoard() {
    ...
    function Ordenation(dataBase: [{userId: number, name: string, birthdate: string, occupation: string, experience: number, name:string, }])
    {
        const filter = dataBase.sort((a,b)=>a.experience - b.experience)
        setFilters(filter);
    }
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel onClick={} control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" />
