...
export default function DashBoard() {
    ...
    function orderResult(filterresult: [{ userId: number, name: string, birthDate: string, occupation: string, experience: number }], stateToOrder: [{ userId: number, name: string, birthDate: string, occupation: string, experience: number }], orderParam: boolean,orderType:string ) {
        
        Ordenation(stateToOrder, orderParam, orderType);
        return ( {filterresult?.map((item, index) =>(<TableRow key={index}>
