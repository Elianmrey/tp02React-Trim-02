...
export default function DashBoard() {
    ...
    function Ordenation(stateToOrder: [{userId: number, name: string, birthdate: string, occupation: string, experience: number}],paramOrdenation: boolean = false, orderType: string = 'asc' | 'desc' ) {
        if(paramOrdenation=== true && orderType === 'desc')
            setFilters(stateToOrder.sort((a, b) => { return a.experience - b.experience }));
        else if(paramsOrenation,orderType === 'asc')
            setFilters(stateToOrder.sort((a, b) => { return b.experience - a.experience }));    
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <FormControlLabel onClick={()=>Ordenation(dataBase,'older')} control={<Checkbox icon={<StarBorder sx={{ color: 'black' }} />} checkedIcon={<Star />} />} label="Mais antigos" />
