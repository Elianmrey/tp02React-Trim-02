...
export default function DashBoard() {
    ...
    function orderResult(filterstateToOrder: [{ userId: number, name: string, birthDate: string, occupation: string, experience: number }], orderParam: boolean,orderType:string ) {
