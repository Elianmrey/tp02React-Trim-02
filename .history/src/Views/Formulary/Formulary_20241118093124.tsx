...
<<<<<<< Tabnine <<<<<<<
                        <DateTimePicker label="Selecione a data de nascimento" value={info?.name} onChange={(e) => setInfo(...info, dayjs(e).value)} />//-
...
//+
                        ...
                        />//+
>>>>>>> Tabnine >>>>>>>// {"conversationId":"f6e7785e-540b-4abd-af50-6d8259c5ddde","source":"instruct"}
                    </DemoContainer>
