...
export default function Formulary() {
    ...
    return (
        <div className={styles.container}>
            ...
            <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', alignItems: 'center' ,backgroundColor: 'orange', borderRadius: '10px', padding: '10px' }}></Container>
            <Typography variant='h4'>Adicione seus dados</Typography>
          
            <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', alignItems: 'center' ,backgroundColor: 'orange', borderRadius: '10px', padding: '10px' }}>
