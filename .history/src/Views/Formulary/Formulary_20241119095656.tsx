...
const MaterialStyles = {
    containerTitle: { display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', alignItems: 'center' ,backgroundColor: 'transparent', borderRadius: '10px', padding: '10px' }
    input: {
        width: '100%',
        marginBottom: '10px',
        color: 'black',
