...
export default function Formulary() {
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={MaterialStyles.form} onSubmit={(e) => onSubmit(e)}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br" >
                    ...
                    <DemoContainer components={['DateTimePicker']} sx={MaterialStyles.dateTimePickerContainer} locale="pt-br">
                        <DateTimePicker name='birthDate' label="Selecione a data de nascimento" value={info?.birthDate ? dayjs(info.birthDate) : null}
                            onChange={(date) => setInfo(prevInfo => ({ ...prevInfo, birthDate: date?.toISOString() ?? '' }))} sx={MaterialStyles.dateTimePicker} />
                    </DemoContainer>
                </LocalizationProvider>

                <InputLabel htmlFor="profession" sx={MaterialStyles.inputLabel}>Ocupação:</InputLabel>
                <Input name='profession' type="text" placeholder="Digite sua ocupação" sx={MaterialStyles.input} value={info?.occupation} onChange={(e) =>HandleChange(e) }/>

                <InputLabel htmlFor="experience" sx={MaterialStyles.inputLabel}>Tempo de experiência:</InputLabel>
                <Input name='experience' type="text" placeholder="Digite o tempo de experiência" sx={MaterialStyles.input}  value={info?.name} onChange={(e) =>HandleChange(e) }/>
