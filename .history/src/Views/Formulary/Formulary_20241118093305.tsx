            ...
            <FormGroup sx={MaterialStyles.form}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br" >
                    ...
                    <DemoContainer components={['DateTimePicker']} sx={MaterialStyles.dateTimePicker}>
                        ...
                        <DateTimePicker label="Selecione a data de nascimento" value={info?.birthDate ? dayjs(info.birthDate) : null} onChange={(date) => setInfo(prevInfo => ({ ...prevInfo, birthDate: date?.toISOString() ?? '' }))}
                        />
                    </DemoContainer>
