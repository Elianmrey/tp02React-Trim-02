...
const MaterialStyles = {
    ...
    containerForm: { display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', alignItems: 'center' ,backgroundColor: 'orange', borderRadius: '10px', padding: '10px' }
    inputLabel: {
        color: 'black',
    },
