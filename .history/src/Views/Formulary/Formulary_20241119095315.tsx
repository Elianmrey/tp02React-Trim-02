...
export default function Formulary() {
    ...
    return (
        <div className={styles.container}>
            ...
            <Container sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', width: '100%', alignItems: 'center' ,backgroundColor: 'indigo', borderRadius: '10px', padding: '10px' }}>
