    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={MaterialStyles.form}>
                ...
                <Input name='profession' type="text" placeholder="Digite sua ocupação" sx={MaterialStyles.input} />

                <InputLabel htmlFor="experience" sx={MaterialStyles.inputLabel}>Tempo de experiência:</InputLabel>
                <Input name='experience' type="text" placeholder="Digite o tempo de experiência" sx={MaterialStyles.input} />
