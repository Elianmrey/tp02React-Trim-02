    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={MaterialStyles.form}>
                ...
                <InputLabel htmlFor="bi" sx={MaterialStyles.inputLabel} >Data de nascimento:</InputLabel>
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br" >
                    
                    <DemoContainer components={['DateTimePicker']} sx={MaterialStyles.dateTimePicker}>

                        <DateTimePicker label="Selecione a data de nascimento" value={info?.birthDate ? dayjs(info.birthDate) : null}
