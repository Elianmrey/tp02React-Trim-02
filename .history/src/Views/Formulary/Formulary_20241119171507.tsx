            ...
            <FormGroup sx={MaterialStyles.form}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="pt-br" >
                    ...
                    <DemoContainer components={['DateTimePicker']} sx={MaterialStyles.dateTimePickerContainer} locale="pt-Br">
                        <DatePicker  name='birthDate' label="Selecione a data de nascimento" value={dayj}  onChange={(date) => setInfo((prevData) => ({ ...prevData, birthDate: new Date(date).toLocaleDateString('pt-BR') }))}
