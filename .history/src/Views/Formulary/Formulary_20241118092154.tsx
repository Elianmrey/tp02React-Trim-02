...
<<<<<<< Tabnine <<<<<<<
                <Input name='name' type="text" placeholder="Digite seu nome" sx={MaterialStyles.input} value={info} onChange={(e) => setInfo(...info:[]|null, e.target.value)}/>//-
                <Input//+
                    name='name'//+
                    type="text"//+
                ...
                />//+
>>>>>>> Tabnine >>>>>>>// {"conversationId":"b7bfb75f-8d20-4213-a91a-d0efde6cad2a","source":"instruct"}
