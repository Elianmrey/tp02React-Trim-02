...
function HandleSubmit() {
    if(!info?.name || !info?.birthDate || !info?.occupation) {
    ...
    return (
        <div className={styles.container}>
            ...
            <FormGroup sx={MaterialStyles.form} onSubmit={(e) => onSubmit(e)}>
                ...
                <Input name='profession' type="text" placeholder="Digite sua ocupação" sx={MaterialStyles.input} value={info?.name} onChange={(e) =>HandleChange(e, 'occupation') }/>
