...
interface AppContextInterface 
{
    ...
    ShowAlert: (message: string, severity: 'success' | 'error' | 'warning' | 'info') => React.ReactNode;
}
...
const AppProvider: React.FC<AppProviderprops> = ({ children }) => {
    ...
    function ShowAlert(message: string, severity: 'success' | 'error' | 'warning' | 'info' | undefined) {
